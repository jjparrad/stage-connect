...
class OfferCandidatesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view = inflater.inflate(R.layout.fragment_offer_candidates, container, false)
        ...
        val progressTextView = view.findViewById<View>(R.id.in_progress)
        progressTextView.setOnClickListener {
            val bundle = Bundle()
            bundle.putString("position", position)
            bundle.putString("id", offerId)
            val fragment = OfferCandidatesInProgressFragment()
    ...
    private fun updateList(view: View, data: ArrayList<JobApplication>) {
        val adapter = JobApplicationAdapter(
            ...
            onPositiveClick = { application -> continueWithCandidate(application) },
    ...
    private fun continueWithCandidate(application: JobApplication) {
